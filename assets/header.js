    ...
    <div class="container topbar__inner">
      <div class="brand">
        <div style="display: flex; gap: 2px; align-items: center; padding: 6px 10px; border-radius: 14px; background: linear-gradient(135deg, rgba(124,58,237,.9), rgba(34,197,94,.8)); box-shadow: var(--shadow); margin-right: 0.25rem;">
          ...
          <a href="https://onemarbleshort.com" target="_blank" rel="noreferrer" aria-label="One Marble Short" style="padding: 2px; display: flex; color: white;">
            <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <radialGradient id="marbleBaseMono" cx="30%" cy="30%" r="70%">
                ...
                <radialGradient id="marbleGlowMono" cx="35%" cy="25%" r="30%">
                  <stop offset="0%" stop-color="currentColor" stop-opacity="0.8"/>
                  <stop offset="100%" stop-color="currentColor" stop-opacity="0"/>
                </radialGradient>
              </defs>
              <circle cx="12" cy="12" r="9" fill="url(#marbleBaseMono)"/>
              <path d="M5.2 10.8c2.8-2.2 5.8-2 8.6-3.6 1.2-0.7 2.6-0.9 4.2-0.9" stroke="currentColor" stroke-width="2.6" fill="none" stroke-linecap="round" opacity="0.65"/>
              <path d="M5.6 13.2c2.8 1.6 5.4 2 8.2 1 1.8-0.7 3.4-0.7 5.1-0.3" stroke="currentColor" stroke-width="2.2" fill="none" stroke-linecap="round" opacity="0.55"/>
              <path d="M7 7.8c1.5 0.2 3.2 0 5.2-0.8" stroke="currentColor" stroke-width="1" fill="none" opacity="0.45" stroke-linecap="round"/>
              <circle cx="8.4" cy="7.4" r="1.4" fill="url(#marbleGlowMono)"/>
              <circle cx="15.8" cy="15.4" r="1" fill="currentColor" opacity="0.25"/>
            </svg>
          </a>
